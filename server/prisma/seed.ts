  ...
  await prisma.orden.create({   
    data: {  
      ...
      ordenProductos: {
        createMany: {
          data: [
            { cantidad: 4, iva: 0.13, subtotal:8900, total:36500, productoId:2 },
          ],
        },
      },
    },
  ...
  await prisma.orden.create({   
    data: { 
      ...
      ordenProductos: {
        createMany: {
          data: [
            { cantidad: 1, iva: 0.13, subtotal:9300, total:11690, productoId:1 },
          ],
        },
      },
    },
  ...
  await prisma.orden.create({   
    data: { 
      ...
      ordenProductos: {
        createMany: {
          data: [
            { cantidad: 2, iva: 0.13, subtotal:20690, total:22400, productoId:4 },
          ],
        },
      },
    },
